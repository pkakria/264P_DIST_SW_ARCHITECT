		...
		try {
			...
			RegisterStudentHandler objCommandEventHandler6 =
				new RegisterStudentHandler(
					db,
					EventBus.EV_REGISTER_STUDENT_CHECKED,
					EventBus.EV_SHOW);
			RegisterationConflictHandler objCommandEventHandler7 =
					new RegisterationConflictHandler(db, EventBus.EV_REGISTER_STUDENT,
							EventBus.EV_REGISTER_STUDENT_CHECKED);

			ClientInput objClientInput = new ClientInput();
			ClientOutput objClientOutput = new ClientOutput();
			NewLogHandler objLogHandler = new NewLogHandler();
